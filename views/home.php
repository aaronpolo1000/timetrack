                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="text-center mb-5 pb-2">
                            <h1 class="text-white">Bienvenido a CraftVerse</h1>

                            <p class="text-white">Explora y busca la informacion que necesecite     </p>
        ...
        <section class="topics-section section-padding pb-0" id="section_3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="section-title-wrap mb-5">
                            <h4 class="section-title">Minecraft</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-overlay">
                            <a href="detail-page.html" class="custom-block-image-wrap">
                                <img src="images/topics/Criaturas.png"
                                    class="custom-block-image img-fluid" alt="">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-overlay">
                            <a href="detail-page.html" class="custom-block-image-wrap">
                                <img src="images/topics/Encantamientos.jpg"
                                    class="custom-block-image img-fluid" alt="">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-overlay">
                            <a href="detail-page.html" class="custom-block-image-wrap">
                                <img src="images/topics/Biomas.png"
                                    class="custom-block-image img-fluid" alt="">
                            </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-overlay">
                            <a href="detail-page.html" class="custom-block-image-wrap">
                                <img src="images/topics/Alquimia.jpg"
                                    class="custom-block-image img-fluid" alt="">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-overlay">
                            <a href="detail-page.html" class="custom-block-image-wrap">
                                <img src="images/topics/Efectos.png"
                                    class="custom-block-image img-fluid" alt="">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-overlay">
                            <a href="detail-page.html" class="custom-block-image-wrap">
                                <img src="images/topics/Comercio.jpg"
                                    class="custom-block-image img-fluid" alt="">
                            </a>
